...
Это документация для бота Armello @armello_champion_bot.

## Управление работой бота

Управление работй бота выполняется через панель http://159.89.3.192:8000/ui/services/armello_champion_bot
